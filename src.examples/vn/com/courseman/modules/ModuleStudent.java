...
import vn.com.courseman.model.Address;
import vn.com.courseman.model.Enrolment;

@ModuleDescriptor(name = "ModuleStudent", modelDesc = @domainapp.basics.model.meta.module.model.ModelDesc(model = vn.com.courseman.model.Student.class), viewDesc = @domainapp.basics.model.meta.module.ViewDesc(formTitle = "Form: Student", imageIcon = "Student.png", domainClassLabel = "Student", view = domainapp.basics.core.View.class), controllerDesc = @domainapp.basics.model.meta.module.controller.ControllerDesc())
